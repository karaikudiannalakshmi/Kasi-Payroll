...
import { currentYM, monthLabel, daysInMonth, fmt, getRates, HOURS_PER_DAY_NEW, isNewSystem } from '../utils/calculations';
...
export default function DailySheet() {
  ...
  const grid = employees.map(emp => {
    ...
    const dailyData = days.map(d => {
      ...
      const effective = isHol ? HOURS_PER_DAY_NEW + entered : entered;
